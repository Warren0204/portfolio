...
export function createHeader({ mount, store, onNavigate }) {
  ...
  /* The availability chip is gone. It was a second route to Contact beside the
     nav link directly to its left, and its dot said "open to work" in colour
     alone. The fact it carried now reads once, as text at the top of the hero;
     the plain "Contact" nav link above is the text link to the same place. */
